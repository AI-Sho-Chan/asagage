...
def compute_coefficients(
    ...
    # Index minute returns for merge; guard empty frames
    ...
    for ticker in tickers:
        ...
        if minute_df.empty:
            continue
        # Safety: skip if required timestamp column is missing due to upstream data gaps
        if "ts" not in minute_df.columns or "ts" not in nky_ret.columns:
            continue
