...
Private Sub ApplyRealtimeColumns(ByVal ws As Worksheet, Optional ByVal fillLastOverride As Long = 0)
    ...
    End If
        ...
        ' Entry/TP/SL display columns
    Dim entryBuyCol As Long: entryBuyCol = FindColumn(ws, DASH_HEADER_ROW, "EntryBuyPx")
    ...
    If entryBuyCol > 0 And vwapCol > 0 And jthCol > 0 And atrColEntry > 0 Then
        ...
        SetColumnFormula ws, entryBuyCol, fillLast, "=IF(OR(" & vwapRefEB & "=""","",IFERROR(RssMarket(LEFT(" & BuildR1C1Ref(tickerCol, entryBuyCol) & ",FIND(".", " & BuildR1C1Ref(tickerCol, entryBuyCol) & " & ".")-1)," & QuoteForFormula(RssFieldBestBidJP()) & "),""))")"
    End If
    If entrySellCol > 0 And vwapCol > 0 And jthCol > 0 And atrColEntry > 0 Then
        ...
        SetColumnFormula ws, entrySellCol, fillLast, "=IF(OR(" & vwapRefES & "=""","",IFERROR(RssMarket(LEFT(" & BuildR1C1Ref(tickerCol, entrySellCol) & ",FIND(".", " & BuildR1C1Ref(tickerCol, entrySellCol) & " & ".")-1)," & QuoteForFormula(RssFieldBestAskJP()) & "),""))")"
    End If
    ...
    End If
    If tpPriceCol > 0 And slPriceCol > 0 And atrColEntry > 0 And tpKColEntry > 0 And slKColEntry > 0 And jValCol > 0 And entryBuyCol > 0 And entrySellCol > 0 Then
